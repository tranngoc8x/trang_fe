  ...
  const achievements = [
    {
      ...
      number: '15K+',
      title: 'Clients',
      description: 'Clients worldwide using our products'
    },
    {
      id: 2,
      number: '150K+',
      title: 'Downloads',
      description: 'Software downloads from our products'
    },
    {
      id: 3,
      number: '15',
      title: 'Countries',
      description: 'Different countries using our products'
    },
    {
      id: 4,
      number: '100+',
      title: 'Top Partners',
      description: 'Partners working with us globally'
    }
  ];
            ...
            {achievements.map((achievement) => (
              <div key={achievement.id} className="achievement-card">
                <div className="achievement-icon">
                  <svg className="achievement-icon-svg" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
